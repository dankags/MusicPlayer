      ...
      <div className='px-5 flex justify-between gap-2 mt-4'>
        ...
        <div className='playListCard w-48 p-3 flex flex-col justify-center rounded-lg bg-neutral-800 hover:bg-neutral-700/80'>
          ...
          <div className='relative w-full h-36 '>
            ...
            <span className='w-14  absolute left-2 bottom-2 text-xs font-semibold text-white ' >Discover weekly </span>
          ...
          <div className='flex flex-col gap-3 justify-between pt-3'>
            <span className='text-sm font-semibold text-white '>Discover weekly</span>
            <p className='font-normal text-xs text-stone-400 overflow-hidden text-ellipsis'>Your weekly mixtape of fresh music. Enjoy Lorem ipsum, dolor sit amet consectetur adipisicing elit. </p>
          </div>
        </div>
           {/*other clones  */}
           <div className='playListCard w-48 p-3 flex flex-col justify-center rounded-lg bg-neutral-800 hover:bg-neutral-700/80'>
