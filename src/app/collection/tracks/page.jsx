...
import { useDarkMutedColor, useVibrantColor } from '@/utils/customHooks'
...
const Tracks = () => {
  ...
  const handleScroll = (e) => {
    ...
    table.className="w-full relative transtion-all duration-100 listContainer"
  }

  return (
    <div className={`pt-2 ${center ?center:'col-span-8'}`} ref={pageRef}>
    <div className={` h-full rounded-lg overflow-y-scroll  container`}  onScrollCapture={handleScroll}>
      <main className='relative  rounded-lg' style={{backgroundColor:`${useDarkMutedColor("/ab67616d0000b27347cf4de5e9956eda47c0f121.jpg")}`}} >
        
          <NavBar position={"sticky"} color={navbarColor}/>
        
      <div className='h-60 w-full flex pl-4 pb-4 relative items-end '>
        <div className='pb-1 w-4/12 '>
          <Image src='/ab67616d0000b27347cf4de5e9956eda47c0f121.jpg' alt='likedImage' width={pageWidth<=642?200:250} height={pageWidth<=642?200:250} className='shadow-2xl shadow-neutral-950'/>
       </div>
       <div className='pb-1 pl-4 w-9/12'>
         <section>
           ...
           <div>
             <span className={`w-full ${pageWidth<=642?"text-6xl":"text-7xl"} text-neutral-50 font-extrabold whitespace-nowrap text-ellipsis overflow-hidden`}>Liked Songs</span>
           </div>
           <div className='flex items-center mt-7'>
            <div className='h-6 w-6 mr-2'>
             <Image src='/crow.jpg' alt='userProfile' width={250} height={250} className='w-full h-full rounded-full object-cover shadow-md shadow-neutral-950'/>
             </div>
